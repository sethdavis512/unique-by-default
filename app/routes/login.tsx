...
export async function action({ request }: ActionArgs) {
  ...
  const redirectTo = safeRedirect(formData.get("redirectTo"), "/journal");
    ...
    <div className="flex min-h-full flex-col justify-center">
      <div className="mx-auto w-full max-w-md px-8">
        <Form method="post" className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full rounded bg-green-600  py-2 px-4 text-white hover:bg-green-600 focus:bg-green-400"
          >
            Log in
          </button>
